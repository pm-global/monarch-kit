...
- [x] **Orchestrator integration** — `Invoke-DomainAudit -Phase Discovery` calls `New-MonarchReport` at the end of Discovery, writes it to the output root as `00-Discovery-Report.html`

- [x] **Tests: New-MonarchReport**
