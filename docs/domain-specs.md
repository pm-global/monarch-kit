...
**Visual language:** The wrapper's console output follows the design system in docs/reference/report-design-system.md -- console color mapping, spacing translation, and severity prefix conventions.
---
